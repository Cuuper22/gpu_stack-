...
from ..core import Approximation, DifferentialEquation, var, eq
...
eq_carrier_continuity = DifferentialEquation(
    ...
    n_carrier.symbol,
    dn_dt.symbol,
    indep_var=sp.Symbol("t", real=True),
    order=1,
...
SEMICONDUCTOR_VARIABLES = [
    n_carrier, v_drift, A_cross, mu_mob, E_field, V_applied, V_ohmic_drop, L_channel,
    I_current, R_res, rho_res, L_wire, A_wire, T_temp,
...
__all__ = [
    ...
    "V_ohmic_drop", "L_channel", "I_current", "R_res", "rho_res", "L_wire", "A_wire",
    "T_temp", "D_diff", "v_sat", "E_crit", "m_eff_ratio", "m_eff",
    ...
    "eq_resistance_geom", "eq_diffusion_einstein", "eq_critical_field",
